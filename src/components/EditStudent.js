...
function EditStudent()
{
    ...
    useEffect(()=>{
        Axios.get("https://mern-project-devlopment-backend.onrender.com/studentRoute/update-student/"+id)
        .then((res)=>{
            if(res.status === 200)
            {
    ...
    const handleSubmit = () => {
        ...
        Axios.put("https://mern-project-devlopment-backend.onrender.com/studentRoute/update-student/"+id,data)
        .then((res)=>{
            if(res.status === 200)
            {
